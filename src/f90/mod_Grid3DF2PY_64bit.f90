...
real, allocatable :: S_vt_vx(:,:) ! Leaf area (m2) per voxel and vegetation type
real, allocatable :: S_vx(:)       ! Leaf area (m2) per voxel
real, allocatable :: S_vt(:)    ! Leaf area (m2) per vegetation type
real ::      S_canopy        ! Leaf area (m2) of canopy (ex-variable sft)
